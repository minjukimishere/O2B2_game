...
// start 버튼 메소드(게임 시작)
	...
	public void screenDraw(Graphics2D g) { // drawImage 함수는 뒤에서 그려질 수록 실제로 이용자가 볼 때는 앞에서 보이게 된다.
		...
		if (isMainScreen) {
			// 음악 선택 이미지
			g.drawImage(selectedImage, 40, 50, null);
			// 타이틀 이미지
